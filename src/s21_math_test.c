...
START_TEST(test_11_s21_sin_pi_4)
{
...
START_TEST(test_12_s21_sin_pi_3)
{
...
START_TEST(test_13_s21_sin_pi_2)
{
...
START_TEST(test_28_s21_sin_zero)
{
...
START_TEST(test_16_s21_tan_3pi2)
{
...
START_TEST(test_16_s21_tan_minus_3pi2)
{
...
START_TEST(test_16_s21_tan_5pi2)
{
...
START_TEST(test_16_s21_tan_minus_5pi2)
{
...
START_TEST(test_02_s21_sqrt_neg_inf)
{
...
START_TEST(test_07_s21_sqrt_zero)
{
...
START_TEST(acos_07_minus_1_point)
{
long double x = -1.;
long double res = acos(x), s21_res = s21_acos(x);
ck_assert_ldouble_eq(res, s21_res);
...
START_TEST(atan_04_pi_minus_zero)
{
...
START_TEST(asin_minus_05_zero_point)
{
double x = -0.00;
long double s21_res = s21_asin(x), res = asin(x);
ck_assert_ldouble_eq(s21_res, res);
...
int main(void)
{
    ...
    tcase_add_test(tc1_1, floorTest1);
    tcase_add_test(tc1_1, floorTest2);
    tcase_add_test(tc1_1, floorTest3);
    tcase_add_test(tc1_1, floorTest4);
    tcase_add_test(tc1_1, floorTest5);
    tcase_add_test(tc1_1, floorTest6);
    tcase_add_test(tc1_1, floorTest7);
    tcase_add_test(tc1_1, floorTest8);
    tcase_add_test(tc1_1, floorTest9);
    tcase_add_test(tc1_1, floorTest10);
    tcase_add_loop_test(tc1_1, s21_log_1, 1, 86);
    tcase_add_loop_test(tc1_1, s21_log_2, 1, 86);
    ...
    tcase_add_test(tc1_1, s21_pow_31);
    ...
    tcase_add_test(tc1_1, s21_pow_39);
    tcase_add_test(tc1_1, s21_pow_40);
    ...
    tcase_add_test(tc1_1, ceill_nan);
    tcase_add_test(tc1_1, ceill_inf);
    tcase_add_test(tc1_1, ceill_neg_inf);
    ...
    tcase_add_test(tc1_1, cos_6_max);
    tcase_add_test(tc1_1, cos_7_min);
    tcase_add_test(tc1_1, cos_nan);
    tcase_add_test(tc1_1, cos_inf);
    tcase_add_test(tc1_1, cos_neg_inf);
    tcase_add_test(tc1_1, test_01_s21_sin);
    tcase_add_test(tc1_1, test_02_s21_sin);
    tcase_add_test(tc1_1, test_03_s21_sin);
    tcase_add_test(tc1_1, test_04_s21_sin);
    tcase_add_test(tc1_1, test_05_s21_sin);
    tcase_add_test(tc1_1, test_06_s21_sin);
    tcase_add_test(tc1_1, test_07_s21_sin);
    tcase_add_test(tc1_1, test_08_s21_sin);
    tcase_add_test(tc1_1, test_09_s21_sin);
    tcase_add_test(tc1_1, test_10_s21_sin);
    tcase_add_test(tc1_1, test_11_s21_sin);
    tcase_add_test(tc1_1, test_11_s21_sin_pi_4);
    tcase_add_test(tc1_1, test_12_s21_sin);
    tcase_add_test(tc1_1, test_12_s21_sin_pi_3);
    tcase_add_test(tc1_1, test_13_s21_sin);
    tcase_add_test(tc1_1, test_13_s21_sin_pi_2);
    tcase_add_test(tc1_1, test_14_s21_sin);
    tcase_add_test(tc1_1, test_15_s21_sin);
    tcase_add_test(tc1_1, test_16_s21_sin);
    tcase_add_test(tc1_1, test_17_s21_sin);
    tcase_add_test(tc1_1, test_18_s21_sin);
    tcase_add_test(tc1_1, test_19_s21_sin);
    tcase_add_test(tc1_1, test_20_s21_sin);
    tcase_add_test(tc1_1, test_21_s21_sin);
    tcase_add_test(tc1_1, test_22_s21_sin);
    tcase_add_test(tc1_1, test_23_s21_sin);
    tcase_add_test(tc1_1, test_24_s21_sin);
    tcase_add_test(tc1_1, test_25_s21_sin);
    tcase_add_test(tc1_1, test_26_s21_sin);
    tcase_add_test(tc1_1, test_27_s21_sin);
    tcase_add_test(tc1_1, test_28_s21_sin);
    tcase_add_test(tc1_1, test_28_s21_sin_zero);
    tcase_add_test(tc1_1, test_01_s21_tan);
    tcase_add_test(tc1_1, test_02_s21_tan);
    tcase_add_test(tc1_1, test_03_s21_tan);
    tcase_add_test(tc1_1, test_04_s21_tan);
    tcase_add_test(tc1_1, test_05_s21_tan);
    tcase_add_test(tc1_1, test_06_s21_tan);
    tcase_add_test(tc1_1, test_07_s21_tan);
    tcase_add_test(tc1_1, test_08_s21_tan);
    tcase_add_test(tc1_1, test_09_s21_tan);
    tcase_add_test(tc1_1, test_10_s21_tan);
    tcase_add_test(tc1_1, test_11_s21_tan);
    tcase_add_test(tc1_1, test_12_s21_tan);
    tcase_add_test(tc1_1, test_13_s21_tan);
    tcase_add_test(tc1_1, test_14_s21_tan);
    tcase_add_test(tc1_1, test_15_s21_tan);
    tcase_add_test(tc1_1, test_16_s21_tan);
    tcase_add_test(tc1_1, test_16_s21_tan_3pi2);
    tcase_add_test(tc1_1, test_16_s21_tan_minus_3pi2);
    tcase_add_test(tc1_1, test_16_s21_tan_5pi2);
    tcase_add_test(tc1_1, test_16_s21_tan_minus_5pi2);
    tcase_add_test(tc1_1, test_17_s21_tan);
    tcase_add_test(tc1_1, test_18_s21_tan);
    tcase_add_test(tc1_1, test_01_s21_sqrt);
    tcase_add_test(tc1_1, test_02_s21_sqrt_neg_inf);
    tcase_add_test(tc1_1, test_03_s21_sqrt);
    tcase_add_test(tc1_1, test_04_s21_sqrt);
    tcase_add_test(tc1_1, test_05_s21_sqrt);
    tcase_add_test(tc1_1, test_06_s21_sqrt);
    tcase_add_test(tc1_1, test_07_s21_sqrt_zero);
    tcase_add_test(tc1_1, test_08_s21_sqrt);
    tcase_add_test(tc1_1, test_09_s21_sqrt);
    tcase_add_test(tc1_1, test_10_s21_sqrt);
    tcase_add_test(tc1_1, test_11_sqrt);
    tcase_add_test(tc1_1, test_12_sqrt);
    tcase_add_test(tc1_1, test_13_pi);
    tcase_add_test(tc1_1, acos_01);
    tcase_add_test(tc1_1, acos_02_1_2);
    tcase_add_test(tc1_1, acos_03_zero);
    tcase_add_test(tc1_1, acos_04);
    tcase_add_test(tc1_1, acos_05);
    tcase_add_test(tc1_1, acos_06_1_point);
    tcase_add_test(tc1_1, acos_07_minus_1_point);
    tcase_add_test(tc1_1, acos_08);
    tcase_add_test(tc1_1, acos_09);
    tcase_add_test(tc1_1, acos_10_pi);
    tcase_add_test(tc1_1, acos_10_pi_2);
    tcase_add_test(tc1_1, acos_11_nan);
    tcase_add_test(tc1_1, acos_12_inf);
    tcase_add_test(tc1_1, acos_12__neg_inf);
    tcase_add_test(tc1_1, atan_01_pi);
    tcase_add_test(tc1_1, atan_02_pi_2);
    tcase_add_test(tc1_1, atan_03_pi_zero);
    tcase_add_test(tc1_1, atan_04_pi_minus_zero);
    ...
    tcase_add_test(tc1_1, atan_nan);
    tcase_add_test(tc1_1, atan_inf);
    tcase_add_test(tc1_1, atan_neg_inf);
    tcase_add_test(tc1_1, asin_01);
    tcase_add_test(tc1_1, asin_02);
    tcase_add_test(tc1_1, asin_03_minus_1);
    tcase_add_test(tc1_1, asin_04_1);
    tcase_add_test(tc1_1, asin_05_zero);
    tcase_add_test(tc1_1, asin_minus_05_zero_point);
    tcase_add_test(tc1_1, asin_06);
    tcase_add_test(tc1_1, asin_07);
    tcase_add_test(tc1_1, asin_07a);
    tcase_add_test(tc1_1, asin_08);
    tcase_add_test(tc1_1, asin_09);
    tcase_add_test(tc1_1, asin_10);
    tcase_add_test(tc1_1, asin_11_nan);
    tcase_add_test(tc1_1, asin_11_inf);
    tcase_add_test(tc1_1, asin_11_neg_inf);
